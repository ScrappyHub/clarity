...
$boot += ''
$boot += '# contracts/event_types.v1.json (safe; no nested quotes)
$boot += '
$boot += "$evLines = @()
$boot += "$evLines += {"
$boot += "$evLines += ('  ""schema"": ""event_types.v1"",')
$boot += "$evLines += ('  ""producer"": ""clarity"",')
$boot += "$evLines += ('  ""types"": [')
$boot += "$evLines += ('    ""clarity.run.started.v1"",')
$boot += "$evLines += ('    ""clarity.verification.result.v1"",')
$boot += "$evLines += ('    ""clarity.run.completed.v1"",')
$boot += "$evLines += ('    ""clarity.library.object.added.v1"",')
$boot += "$evLines += ('    ""clarity.library.object.sealed.v1"",')
$boot += "$evLines += ('    ""clarity.nfl.packet.built.v1"",')
$boot += "$evLines += ('    ""clarity.nfl.packet.verified.v1"",')
$boot += "$evLines += ('    ""clarity.nfl.pledged.local.v1"",')
$boot += "$evLines += ('    ""clarity.nfl.duplicated.v1"",')
$boot += "$evLines += ('    ""clarity.nfl.duplicate.failed.v1""')
$boot += "$evLines += "  ]"
$boot += "$evLines += "}"
$boot += "WriteUtf8Lf (Join-Path $RepoRoot ""contracts\event_types.v1.json"") (($evLines -join ""`n"") + ""`n"")
$boot += '
